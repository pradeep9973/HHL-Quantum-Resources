#author : pradeep 
# 3D system of equations example of hhl 
...
def PSI_3_3d_GGM_checking(b_0=0.5,b_1=0.4,eta_1=1,eta_2=2,eta_3=3):
    # here the eigenvalue is represented by a single vector
...
def plot_sp():
    ...
    for i in range(50):
        for j in range(50):
            ...
            # ggm_3d[i, j] = ggm_ij
            sp_ij = success_prob_3d(PSI_3_3d_GGM_checking(np.sqrt(i/100.0), np.sqrt(j/100.0)))
            sp_3d[i,j] = sp_ij
            # file.write(f"{i} {j} {ggm_ij} {sp_ij}\n")
        print(i)
    plot_3d(sp_3d)
